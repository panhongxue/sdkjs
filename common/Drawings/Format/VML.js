	...
	function (window, undefined) {
		...
		function GetValue(strParam, oRes, lShapeWidth, lShapeHeight) {
			...
			if ('#' === strParam[0]) {
				...
				if (!AscFormat.isRealNumber(nNumVal)) {
					if ("width" === strParam) { val = lShapeWidth_; }
					else if ("height" === strParam) { val = lShapeHeight_; }
					else if ("pixelWidth" === strParam) { val = lShapeWidth_; }
					else if ("pixelHeight" === strParam) { val = lShapeHeight_; }
					else if ("pixelLineWidth" === strParam || "lineDrawn" === strParam) { val = 1; }
					else {
						oRes.bRes = false;
						return 0;
					}
		...
		CVmlGeometryData.prototype.ConvertSlice_AngleEllipse = function (oSlice, oOOXMLPath) {
			...
			for (let j = 0; j < oSlice.m_arPoints.length; j += 3) {
				...
				this.m_lIndexSrc++;
				this.convertProd(this.pCurPoint1.x, this.pCurPointType1.x, pow3_16, ParamType.ptValue, this.m_oParam.m_lParam, this.m_oParam.m_eType, false, true, true);
				this.convertProd(this.pCurPoint1.y, this.pCurPointType1.y, pow3_16, ParamType.ptValue, this.m_oParam.m_lParam, this.m_oParam.m_eType, false, true, true);
				this.m_arIndexDst.push(this.m_lIndexDst - 1);
		...
		CVmlGeometryData.prototype.fillCActionButtonBeginType = function () {
			this.concentricFill = true;
			this.join = ODRAW.lineJoinMiter;
		...
		CVmlGeometryData.prototype.fillCActionButtonReturnType = function () {
			this.concentricFill = true;
			this.join = ODRAW.lineJoinMiter;
		...
		CVmlGeometryData.prototype.fillCActionButtonDocType = function () {
			this.concentricFill = true;
			this.join = ODRAW.lineJoinMiter;
		...
		CVmlGeometryData.prototype.fillCEllipseRibbonType = function () {
			this.concentricFill = false;
			this.join = ODRAW.lineJoinMiter;
			//Encaps: Flat
		...
		function Cm_To_Mm(dValue) { return dValue * 10; }
		function Cm_To_Pt(dValue) { return dValue * 72 / 2.54; }
		function Cm_To_Px(dValue) { return dValue * 72 * 4 / 3 / 2.54; }
		function Cm_To_Inch(dValue) { return dValue / 2.54; }
		function Cm_To_Dx(dValue) { return dValue * 72 * 20 / 2.54; }
		function Cm_To_Sx(dValue) { return dValue * 72 * 100 * 1000 / 20; }
		function Cm_To_Multi(dValue) { return dValue * 72 * 20 / 2.54; }
		function Cm_To_Emu(dValue) { return dValue * 360000; }

		function Mm_To_Cm(dValue) { return dValue / 10; }
		function Mm_To_Pt(dValue) { return dValue * 72 / 10 / 2.54; }
		function Mm_To_Px(dValue) { return dValue * 72 * 4 / 3 / 10 / 2.54; }
		function Mm_To_Inch(dValue) { return dValue / 2.54 / 10; }
		function Mm_To_Dx(dValue) { return dValue * 72 * 20 / 10 / 2.54; }
		function Mm_To_Sx(dValue) { return dValue * 72 * 100 * 1000 / 10 / 20; }
		function Mm_To_Multi(dValue) { return dValue * 72 * 20 / 10 / 2.54; }
		function Mm_To_Emu(dValue) { return dValue * 36000 + 0.5 >> 0; }

		function Pt_To_Cm(dValue) { return dValue * 2.54 / 72; }
		function Pt_To_Mm(dValue) { return dValue * 2.54 * 10 / 72; }
		function Pt_To_Px(dValue) { return dValue * 4 / 3; }
		function Pt_To_Inch(dValue) { return dValue / 72; }
		function Pt_To_Dx(dValue) { return dValue * 20; }
		function Pt_To_Sx(dValue) { return dValue * 2.54 * 100 * 1000 / 20; }
		function Pt_To_Multi(dValue) { return dValue * 20; }
		function Pt_To_Emu(dValue) { return dValue * 12700; }

		function Px_To_Cm(dValue) { return dValue * 2.54 * 3 / 72 / 4; }
		function Px_To_Mm(dValue) { return dValue * 2.54 * 10 * 3 / 72 / 4; }
		function Px_To_Pt(dValue) { return dValue * 3 / 4; }
		function Px_To_Inch(dValue) { return dValue * 3 / 72 / 4; }
		function Px_To_Dx(dValue) { return dValue * 20 * 3 / 4; }
		function Px_To_Sx(dValue) { return dValue * 2.54 * 100 * 1000 * 3 / 20 / 4; }
		function Px_To_Multi(dValue) { return dValue * 20 * 3 / 4; }
		function Px_To_Emu(dValue) { return (dValue * 9525 + 0.5) >> 0; }

		function Inch_To_Cm(dValue) { return dValue * 2.54; }
		function Inch_To_Mm(dValue) { return dValue * 2.54 * 10; }
		function Inch_To_Pt(dValue) { return dValue * 72; }
		function Inch_To_Px(dValue) { return dValue * 72 * 4 / 3; }
		function Inch_To_Dx(dValue) { return dValue * 72 * 20; }
		function Inch_To_Sx(dValue) { return dValue * 1000 * 100 * 2.54 * 72 / 20; }
		function Inch_To_Multi(dValue) { return dValue * 72 * 20; }
		function Inch_To_Emu(dValue) { return dValue * 914400; }

		function Dx_To_Cm(dValue) { return dValue * 2.54 / 72 / 20; }
		function Dx_To_Mm(dValue) { return dValue * 2.54 * 10 / 72 / 20; }
		function Dx_To_Pt(dValue) { return dValue / 20; }
		function Dx_To_Px(dValue) { return dValue * 4 / 3 / 20; }
		function Dx_To_Inch(dValue) { return dValue / 20 / 72; }
		function Dx_To_Sx(dValue) { return dValue * 635; }
		function Dx_To_Multi(dValue) { return dValue; }
		function Dx_To_Emu(dValue) { return dValue * 635; }

		function Sx_To_Cm(dValue) { return dValue * 20 / 72 / 100 / 1000; }
		function Sx_To_Mm(dValue) { return dValue * 20 / 72 / 100 / 1000 * 10; }
		function Sx_To_Pt(dValue) { return dValue * 20 / 100 / 1000 / 2.54; }
		function Sx_To_Px(dValue) { return dValue * 20 * 4 / 3 / 100 / 1000 / 2.54; }
		function Sx_To_Inch(dValue) { return dValue * 20 / 2.54 / 72 / 100 / 1000; }
		function Sx_To_Dx(dValue) { return dValue * 20 * 20 / 2.54 / 100 / 1000; }
		function Sx_To_Multi(dValue) { return dValue * 20 * 20 / 2.54 / 100 / 1000; }
		function Sx_To_Emu(dValue) { return dValue; }

		function Multi_To_Cm(dValue) { return dValue * 2.54 / 72 / 20; }
		function Multi_To_Mm(dValue) { return dValue * 2.54 * 10 / 72 / 20; }
		function Multi_To_Pt(dValue) { return dValue / 20; }
		function Multi_To_Px(dValue) { return dValue * 4 / 3 / 20; }
		function Multi_To_Inch(dValue) { return dValue / 20 / 72; }
		function Multi_To_Sx(dValue) { return dValue * 635; }
		function Multi_To_Dx(dValue) { return dValue; }
		function Multi_To_Emu(dValue) { return dValue * 635; }

		function Emu_To_Cm(dValue) { return dValue / 360000; }
		function Emu_To_Mm(dValue) { return dValue / 36000; }
		function Emu_To_Pt(dValue) { return dValue / 12700; }
		function Emu_To_Twips(dValue) { return dValue / 635; }
		function Emu_To_Px(dValue) { return dValue / 9525; }
		function Emu_To_Inch(dValue) { return dValue / 914400; }
		function Emu_To_Sx(dValue) { return dValue; }
		function Emu_To_Dx(dValue) { return dValue / 635; }
		function Emu_To_Multi(dValue) { return dValue / 635; }
		...
		function CPoint(sValue) {
			CUniversalMeasure.call(this);
			if (sValue) { this.FromString(sValue); }
		}
		...
		CLegacyDrawing.prototype.getHFId = function () {
			for (let nItem = 0; nItem < this.items.length; ++nItem) {
				let oItem = this.items[nItem];
				if (oItem instanceof CShape) {
					let sId = oItem.m_sId;
		...
		function isEmptyObject(oObj) {
			...
			for (let sKey in oObj) {
				if (oObj.hasOwnProperty(sKey)) { return false; }
			}
			return true;
		}

		const shemeDefaultColor = [
		...
		*/
		...
		window['AscFormat'].CLegacyDrawing = CLegacyDrawing;
