...
(function(window, undefined)
{
	...
	baseEditorsApi.prototype.openWorkbookForExternalReferencesFromZip = function (wb, stream) {
		//TODO зачитать sharedStrings
		if (!stream || !this["asc_isSupportFeature"]("ooxml")) {
			return null;
		}
		...
		AscFormat.ExecuteNoHistory(function() {
			...
			xmlParserContext.DrawingDocument = this.getDrawingDocument();
