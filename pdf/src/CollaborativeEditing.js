...
CPDFCollaborativeEditing.prototype = Object.create(AscCommon.CCollaborativeEditingBase.prototype);
CPDFCollaborativeEditing.prototype.constructor = CPDFCollaborativeEditing;
CPDFCollaborativeEditing.prototype.GetEditorApi = function()
{
...
CPDFCollaborativeEditing.prototype.GetDrawingDocument = function()
{
    if(this.m_oLogicDocument)
    {
...
CPDFCollaborativeEditing.prototype.Clear = function()
{
...
CPDFCollaborativeEditing.prototype.Send_Changes = function(IsUserSave, AdditionalInfo, IsUpdateInterface, isAfterAskSave)
{
    ...
    this.m_oLogicDocument.UpdateUndoRedo();
    ...
    if (0 !== UnlockCount || 1 !== this.m_nUseType)
    {
        ...
        this.m_oLogicDocument.DrawingDocument.ClearCachePages();
        this.m_oLogicDocument.DrawingDocument.FirePaint();
    }

    // this.m_oLogicDocument.getCompositeInput().checkState();
};
...
CPDFCollaborativeEditing.prototype.Apply_Data = function()
{
...
CPDFCollaborativeEditing.prototype.Apply_OtherChanges = function()
{
...
CPDFCollaborativeEditing.prototype.OnEnd_CheckLock = function(isDontLockInFastMode, fCallback)
{
...
CPDFCollaborativeEditing.prototype.OnCallback_AskLock = function(result)
{
...
CPDFCollaborativeEditing.prototype.AddContentControlForSkippingOnCheckEditingLock = function(oContentControl)
{
	this.m_aSkipContentControlsOnCheckEditingLock[oContentControl.GetId()] = oContentControl;
};
CPDFCollaborativeEditing.prototype.RemoveContentControlForSkippingOnCheckEditingLock = function(oContentControl)
{
	delete this.m_aSkipContentControlsOnCheckEditingLock[oContentControl.GetId()];
};
CPDFCollaborativeEditing.prototype.IsNeedToSkipContentControlOnCheckEditingLock = function(oContentControl)
{
...
CPDFCollaborativeEditing.prototype.Start_CollaborationEditing = function()
{
	this.m_nUseType = -1;
};
CPDFCollaborativeEditing.prototype.End_CollaborationEditing = function()
{
	if (this.m_nUseType <= 0)
	{
...
//----------------------------------------------------------------------------------------------------------------------
CPDFCollaborativeEditing.prototype.Remove_ForeignCursor = function(UserId)
{
...
CPDFCollaborativeEditing.prototype.Update_ForeignCursorsPositions = function()
{
...
CPDFCollaborativeEditing.prototype.private_RecalculateDocument = function(arrChanges)
{
	this.m_oLogicDocument.RecalculateByChanges(arrChanges);
};
CPDFCollaborativeEditing.prototype.private_UpdateForeignCursor = function(CursorInfo, UserId, Show, UserShortId)
{
...
window['AscPDF'].CollaborativeEditing = new CPDFCollaborativeEditing();
